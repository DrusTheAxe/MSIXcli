...
If this step generates review sheets, annotated images, or other image artifacts, save them in:

`D:\source\repos\msixcli\images\graphic-design\step2`

Use `step2` by default for generated images unless the user explicitly specifies a different output directory.
